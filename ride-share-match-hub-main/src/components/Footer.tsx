        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link to="/taxi" className="text-gray-300 hover:text-white hover:underline">
                  Find My Taxi
                </Link>
              </li>
              <li>
                <Link to="/jobs" className="text-gray-300 hover:text-white hover:underline">
                  Find My Job
                </Link>
              </li>
              <li>
                <Link to="/roommates" className="text-gray-300 hover:text-white hover:underline">
                  Find My Roommate
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link to="/careers" className="text-gray-300 hover:text-white hover:underline">
                  Careers
                </Link>
              </li>
              <li>
